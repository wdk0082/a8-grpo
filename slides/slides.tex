...
\vspace{3pt}
\centering
\includegraphics[width=0.95\linewidth]{F2_accuracy.pdf}\\[5pt]
\raggedright\small
\good{\textbf{R3b}} ($K{=}8$) tops out at \textbf{57.2\%}; both $K{=}8$ runs beat base at best \emph{and} final, while \bad{R0} and \bad{R1} \bad{collapse} to near-zero by their final step. (\run{R2} is a supplementary length-penalty variant.)
\end{frame}
